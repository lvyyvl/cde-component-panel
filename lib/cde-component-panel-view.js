...
export default class CdeComponentPanelView{
  ...
  getPluginComponent(componentPath, pngPath){
    ...
    // let panelHeading = titleValue.split(":")[0]==undefined?'':titleValue.split(":")[0];
    // let panelBody = titleValue.split(":")[1]==undefined?'':titleValue.split(":")[1];
